...
class List extends Component {
    ...
    fetchRecordsMe = async() =>{
        ...
        this.setState({ 'fetchRecords': await fetchRecords(email,pass,this.state.module, this.state.module, {"mode":this.state.mode}, filter ,this.state.page, this.state.perPage, this.state.order_by, this.state.order) });
    }
