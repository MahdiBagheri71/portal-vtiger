...
import {updateLang,vtranslate,describeModule,fetchRecord,downloadFile} from '../../../../Functions/Portal' ;
                ...
                <View>
                    ...
                    <View style={styles.recordField}>
                        <Text style={styles.recordLabel}>
                            {vtranslate('Attachments')}
                        </Text>
                        <Text style={styles.recordValue}>
                            <Button icon="tray-arrow-down" style={styles.attachment}  mode="contained" color="#428bca" onPress={() => this.downloadDocumentFile(this.state.record['record']['id'])}>
                                {vtranslate('Download')}
                            </Button>
                        </Text>
                    </View>
