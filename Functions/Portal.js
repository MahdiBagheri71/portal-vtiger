...
async function api(details, encoded_base64) {
    ...
    myHeaders.append("Authorization", 'Basic ' + encoded_base64);
    myHeaders.append("Content-Type", "application/x-www-form-urlencoded");

    let formBody = Object.entries(details)
...
export const uploadAttachment = async (user_name, password, data) => {
    ...
    let text = user_name + ":" + password;
    let encoded_base64 = base64.encode(text);
    return await (
...
export const ping = async (user_name, password) => {
    ...
    let result = await api(details, encoded_base64);
